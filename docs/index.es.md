...
-   :material-package-variant-closed:{ .lg .middle } __Componentes__
    ...
    [:octicons-arrow-right-24: Resumen](components/overview.md)
...
-   :material-palette:{ .lg .middle } __Tema__
    ...
    [:octicons-arrow-right-24: Resumen del tema](theme/index.md)
...
-   :material-heart:{ .lg .middle } __Contribuir__
    ...
    [:octicons-arrow-right-24: Cómo contribuir](support/index.md)
...
-   :material-school:{ .lg .middle } __¿Primera vez?__
    ...
    [:octicons-arrow-right-24: Introducción](introduction/index.md)
